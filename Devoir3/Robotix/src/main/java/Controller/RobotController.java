...
/*      if (client.getFleet().size() == 0){
            displayMessage("You have no robots!", false);
        } else {
            displayMessage("Here are your robots!", false);
        }*/
/*        Button creat = new Button("Create My Robot");
        GridPane grid = new GridPane();
        DisplayRobots.getChildren().add(creat);
        grid.add(creat, 0, 0);
        grid.setAlignment(Pos.CENTER);*/
    }


    public void welcomePage(ActionEvent actionEvent) {
    ...
    public void afficherRobot(ActionEvent actionEvent,Label robotlist) {
        String robot = "";
        if(client.getFleet().size() == 0){
            robotlist.setText("You have no robots!");
...
/*    private void welcome(ActionEvent action) {
        Button createMyRobots = new Button("Create My Robots");
        createMyRobots.setOnAction(e -> creatRobot(e));
        DisplayRobots.getChildren().add(createMyRobots);
