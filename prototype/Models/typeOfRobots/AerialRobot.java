...
public class AerialRobot extends Robot{
    ...
    public AerialRobot(String name, String type, ArrayList<Component> components, UUID serialNumber, int battery,
    double [] position, double speed, double CPUUsage, double memory, double flightAltitude) {
    ...
    public void robotData(){
        ...
        System.out.println("Altitude de vol " + this.flightAltitude + "\n");
    }
