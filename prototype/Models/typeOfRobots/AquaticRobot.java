...
public class AquaticRobot extends Robot{
    ...
    public AquaticRobot (String name, String type, ArrayList<Component> components, UUID serialNumber,
     int battery, double [] position, double speed, double CPUUsage, double memory, double depth) {
    ...
    public void robotData(){
        ...
        System.out.println("Profondeur " + this.depth + "\n");
    }
}
